    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnconfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!name.isEmpty() && !name.isEmpty() && !name.isEmpty() && imagePath != null){
                    ...
                    if (priceDouble >0){
                        ...
                        Toast.makeText(AdminAddBook.this, "Please enter price more than 0", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(AdminAddBook.this, "Please enter all information", Toast.LENGTH_SHORT).show();
                }
