...
//        mCooLayout = (CoordinatorLayout) findViewById(R.id.cl);
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Brief Introduction"));
        tabLayout.addTab(tabLayout.newTab().setText("About the Author"));
        tabLayout.addTab(tabLayout.newTab().setText("Table of contents"));
    ...
    private void setupViewPager(ViewPager mViewPager) {
        ...
        adapter.addFragment(DetailFragment.newInstance(mBook.getSummary()), "Brief Introduction");
        adapter.addFragment(DetailFragment.newInstance(mBook.getAuthor_intro()), "About the Author");
        adapter.addFragment(TOCDetailFragment.newInstance(mBook.getCatalog()), "Table of contents");
