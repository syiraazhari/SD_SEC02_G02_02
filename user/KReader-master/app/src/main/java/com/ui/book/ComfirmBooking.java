...
public class ComfirmBooking extends AppCompatActivity {
    ...
    private  String ifullname,iicnumber,ipnumber,inbook,iquantity,irentdate,iprice, irentday, irentmonth, irentyear, istatus, ioffer, userstudentrole;
                    ...
                    dis = 0.0;*/
                        ...
                        databaseReference.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                Log.i(TAG,"id2 is" +userstudentrole);
